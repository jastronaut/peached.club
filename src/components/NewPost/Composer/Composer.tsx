...
export const ComposerComponent = (
	...
	const [postText2, setPostText2] = useState<string>('<p><br></p>');
	...
	const onSubmitPost = useCallback(() => {
		const parsedComposerText = parseHTMLForUpload(postText2, uploadedImages);

		if (parsedComposerText[0]) {
			onSubmit(parsedComposerText);
		}
	}, [postText2, uploadedImages, onSubmit]);
	...
	const isComposerEmpty = !postText2 || postText2 === EMPTY_COMPOSER_CONTENT;
